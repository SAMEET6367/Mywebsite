    ...
    <header className="sticky top-0 z-50 border-b border-ink-700/70 bg-ink-950/80 backdrop-blur-md">
      <Container className="flex h-16 items-center justify-between">
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <a href="/login" className="text-sm text-fog transition-colors hover:text-paper">
            Log in
          </a>
          <a href="/signup" className="rounded-full border border-ink-700 px-4 py-2 text-sm font-medium text-paper transition-colors hover:border-violet-bright/60 hover:bg-ink-900">
            Sign up
          </a>
      ...
      {open && (
        <div className="border-t border-ink-700/70 bg-ink-950/95 backdrop-blur-md md:hidden">
          <Container className="flex flex-col gap-1 py-4">
            ...
            <a href="/login" onClick={() => setOpen(false)} className="rounded-lg px-2 py-3 text-base text-fog transition-colors hover:bg-ink-900 hover:text-paper">
              Log in
            </a>
            <a href="/signup" onClick={() => setOpen(false)} className="rounded-lg px-2 py-3 text-base text-fog transition-colors hover:bg-ink-900 hover:text-paper">
              Sign up
            </a>
